...
router.post("/addrecipe",authMiddleware,uploadRecipes.single('image'),(req, res, next) => {
...
router.put('/updaterecipe/:id',authMiddleware,isAdmin,uploadRecipes.single('image'),(req, res, next) => {
    // Validate the form data
    const formData = {
      name: req.body.name,
      image: req.file ? req.file.filename : "", // Convert the buffer to base64
